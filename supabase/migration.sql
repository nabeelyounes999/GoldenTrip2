...
-- Initial Data
INSERT INTO team_members (name, role, image, bio, socials) VALUES
('Thabet', 'Founder & CEO', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400', 'Passionate about creating unforgettable travel experiences.', '{"facebook": "#", "instagram": "#", "whatsapp": "#"}');
...
-- ─── STORAGE ──────────────────────────────────────────
-- Note: These often need to be run separately or through the dashboard,
-- but including them as reference for the user.
INSERT INTO storage.buckets (id, name, public) 
VALUES ('resumes', 'resumes', true)
ON CONFLICT (id) DO NOTHING;

CREATE POLICY "Public Access" ON storage.objects FOR SELECT USING (bucket_id = 'resumes');
CREATE POLICY "Admin Upload" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'resumes');
